...
namespace Codit.Connectors.ApplicationInsights
{
    public class SwaggerConfig
    {
        ...
        {
            var swaggerEnabledConfiguration = EnableSwaggerGeneration();

            if (IsSwaggerUiEnabled())
            {
                EnableSwaggerUi(swaggerEnabledConfiguration);
            }
        }
        ...
        private static bool IsSwaggerUiEnabled()
        {
            bool isSwaggerUiEnabled;

            var rawSetting = ConfigurationProvider.GetSetting("Swagger.EnableUi");
            return bool.TryParse(rawSetting, out isSwaggerUiEnabled) ? isSwaggerUiEnabled : true;
        }
    }
}
